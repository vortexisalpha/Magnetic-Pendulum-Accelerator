...
// trajectory inputs
wire [$clog2(IMG_W * IMG_H)-1:0] traj_px_id = reg_file[21][$clog2(IMG_W * IMG_H)-1:0];

wire traj_valid_0, traj_valid_1, traj_valid_2, traj_valid_3, traj_valid_4, traj_valid_5, traj_valid_6, traj_valid_7;
wire signed [17:0] traj_x_0, traj_x_1, traj_x_2, traj_x_3, traj_x_4, traj_x_5, traj_x_6, traj_x_7;
wire signed [17:0] traj_y_0, traj_y_1, traj_y_2, traj_y_3, traj_y_4, traj_y_5, traj_y_6, traj_y_7;
wire traj_done_0, traj_done_1, traj_done_2, traj_done_3, traj_done_4, traj_done_5, traj_done_6, traj_done_7;
...
one_lane_top #( \
    ...
    .IMG_W(IMG_W), .IMG_H(IMG_H), .LANE_ID(ID), .NUM_LANES(8) \
) u_lane``ID ( \
...
// -------------------------------------------------------------------------
reg [$clog2(IMG_W * IMG_H)-1:0] fb_rd_addr_r;  // global pixel index, 0 to 19199

// find the local pixel index in the slice / lane
// need to change with resolution
wire [$clog2(IMG_W * IMG_H)-1:0] fb_sub1 = fb_rd_addr_r - 15'd2400;
wire [$clog2(IMG_W * IMG_H)-1:0] fb_sub2 = fb_rd_addr_r - 15'd4800;
wire [$clog2(IMG_W * IMG_H)-1:0] fb_sub3 = fb_rd_addr_r - 15'd7200;
wire [$clog2(IMG_W * IMG_H)-1:0] fb_sub4 = fb_rd_addr_r - 15'd9600;
wire [$clog2(IMG_W * IMG_H)-1:0] fb_sub5 = fb_rd_addr_r - 15'd12000;
wire [$clog2(IMG_W * IMG_H)-1:0] fb_sub6 = fb_rd_addr_r - 15'd14400;
wire [$clog2(IMG_W * IMG_H)-1:0] fb_sub7 = fb_rd_addr_r - 15'd16800;
...
reg [2:0]  ps;
reg [$clog2(IMG_W * IMG_H)-1:0] px_done; // count of pixels processed
