...
// -------------------------------------------------------------------------
// frame_done latch - all 9 lanes must finish
// -------------------------------------------------------------------------
...
assign traj_valid_any = traj_valid_0 | traj_valid_1 | traj_valid_2 | traj_valid_3 |
                        traj_valid_4 | traj_valid_5 | traj_valid_6 | traj_valid_7 | traj_valid_8;

assign traj_done_any = traj_done_0 | traj_done_1 | traj_done_2 | traj_done_3 |
                       traj_done_4 | traj_done_5 | traj_done_6 | traj_done_7 | traj_done_8;
...
assign fb_rd_addr_local = fb_rd_addr_r - lane_base;
...
always @(*) begin
    case (lane_sel_r)
        ...
        default: fb_rd_data = fb_rd_data_8;
    endcase
end
    ...
    if (!periph_resetn) begin
        ...
        PS_IDLE: begin
            ...
            if (bram_rd_mode) begin
                fb_rd_addr_r <= reg_file[28][PXID_W-1:0];
            end
